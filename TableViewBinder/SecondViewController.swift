...
//        super.viewDidLoad()
//
//        let section1Models = Observable<[SecondTableViewCell.Model]>.just([
//            SecondTableViewCell.Model(title: "Title", subtitle: "Subtitle")
//        ])
//        let section2Models = Observable<[SecondTableViewCell.Model]>.just([
//            SecondTableViewCell.Model(title: "Title", subtitle: "Subtitle"),
//            SecondTableViewCell.Model(title: "Title", subtitle: "Subtitle")
//        ])
...
//            .bind(cellType: SecondTableViewCell.self, models: [section1Models, section2Models])
