 ...
 */
public class RxSingleSectionTableViewBindResult<C: UITableViewCell, S: TableViewSection> {
    internal let binder: RxSectionedTableViewBinder<S>
    internal let section: S
    
    internal init(binder: RxSectionedTableViewBinder<S>, section: S) {
        self.binder = binder
    ...
    */
    @discardableResult
    public func bind<NC>(cellType: NC.Type, viewModels: Observable<[NC.ViewModel]>) -> RxSingleSectionTableViewBindResult<NC, S>
...
public class RxSingleSectionModelTableViewBindResult<C: UITableViewCell, S: TableViewSection, M>: RxSingleSectionTableViewBindResult<C, S> {
    /**
     Add a handler to be called whenever a cell in the declared section is tapped.
     ...
     */
    @discardableResult
    public func onTapped(_ handler: @escaping (_ row: Int, _ tappedCell: C, _ model: M) -> Void) -> RxSingleSectionModelTableViewBindResult<C, S, M> {
        let section = self.section
     ...
     */
    @discardableResult
    public func onCellDequeue(_ handler: @escaping (_ row: Int, _ dequeuedCell: C, _ model: M) -> Void) -> RxSingleSectionModelTableViewBindResult<C, S, M> {
        let section = self.section
    ...
    @discardableResult
    override public func bind<H>(headerType: H.Type, viewModel: Observable<H.ViewModel>) -> RxSingleSectionModelTableViewBindResult<C, S, M>
        where H: UITableViewHeaderFooterView & RxViewModelBindable & ReuseIdentifiable {
    ...
    @discardableResult
    override public func headerTitle(_ title: Observable<String>) -> RxSingleSectionTableViewBindResult<C, S> {
        super.headerTitle(title)
        return self
    }
    
    @discardableResult
    override public func bind<F>(footerType: F.Type, viewModel: Observable<F.ViewModel>) -> RxSingleSectionModelTableViewBindResult<C, S, M>
    where F: UITableViewHeaderFooterView & RxViewModelBindable & ReuseIdentifiable {
    ...
    @discardableResult
    override public func onCellDequeue(_ handler: @escaping (_ row: Int, _ dequeuedCell: C) -> Void) -> RxSingleSectionModelTableViewBindResult<C, S, M> {
        super.onCellDequeue(handler)
        return self
    }
    
    @discardableResult
    override public func onTapped(_ handler: @escaping (_ row: Int, _ tappedCell: C) -> Void) -> RxSingleSectionModelTableViewBindResult<C, S, M> {
        super.onTapped(handler)
        return self
    }
    
    @discardableResult
    override public func cellHeight(_ handler: @escaping (_ row: Int) -> CGFloat) -> RxSingleSectionModelTableViewBindResult<C, S, M> {
        super.cellHeight(handler)
        return self
    }
    
    @discardableResult
    override public func estimatedCellHeight(_ handler: @escaping (_ row: Int) -> CGFloat) -> RxSingleSectionModelTableViewBindResult<C, S, M> {
